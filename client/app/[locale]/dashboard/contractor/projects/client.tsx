        ...
        <div className="p-4">
          ...
          <div className="flex items-end justify-between gap-3">
            ...
            <Button
              ...
              onClick={() => router.push(`/${locale}/dashboard/contractor/job?jobId=${job._id}&tab=applications`)}
            >
              {isInProgress
                          ...
                          <div className="flex flex-col gap-1.5 shrink-0">
                            <Button
                              ...
                              onClick={() => {
                                ...
                                if (!jobId) return;
                                router.push(`/${locale}/dashboard/contractor/job?jobId=${jobId}&tab=applications&applicationId=${app._id}`);
                              }}
                            >
